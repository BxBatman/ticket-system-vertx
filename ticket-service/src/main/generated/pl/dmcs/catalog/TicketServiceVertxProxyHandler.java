...
public class TicketServiceVertxProxyHandler extends ProxyHandler {
  ...
  public TicketServiceVertxProxyHandler(Vertx vertx, TicketService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public TicketServiceVertxProxyHandler(Vertx vertx, TicketService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public TicketServiceVertxProxyHandler(Vertx vertx, TicketService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "save": {
          service.save(json.getJsonObject("ticket") == null ? null : new pl.dmcs.catalog.Ticket(json.getJsonObject("ticket")), createHandler(msg));
          break;
        }
        case "get": {
          service.get(json.getValue("id") == null ? null : (json.getLong("id").intValue()), res -> {
            if (res.failed()) {
        ...
        case "saveMultiplesSameTickets": {
          service.saveMultiplesSameTickets(json.getJsonObject("ticketDto") == null ? null : new pl.dmcs.catalog.dto.TicketDto(json.getJsonObject("ticketDto")), createHandler(msg));
          break;
        }
