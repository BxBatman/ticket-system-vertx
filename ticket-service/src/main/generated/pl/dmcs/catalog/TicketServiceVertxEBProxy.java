...
public class TicketServiceVertxEBProxy implements TicketService {
  ...
  public TicketServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public TicketServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public TicketService save(Ticket ticket, Handler<AsyncResult<Void>> resultHandler) {
    ...
    JsonObject _json = new JsonObject();
    _json.put("ticket", ticket == null ? null : ticket.toJson());
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
  ...
  public TicketService get(Integer id, Handler<AsyncResult<Ticket>> resultHandler) {
    ...
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        ...
        resultHandler.handle(Future.succeededFuture(res.result().body() == null ? null : new Ticket(res.result().body())));
                      }
    });
    return this;
  }
  ...
  public TicketService saveMultiplesSameTickets(TicketDto ticketDto, Handler<AsyncResult<Void>> resultHandler) {
    ...
    JsonObject _json = new JsonObject();
    _json.put("ticketDto", ticketDto == null ? null : ticketDto.toJson());
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "saveMultiplesSameTickets");
    _vertx.eventBus().<Void>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public TicketService getAll(Handler<AsyncResult<List<Ticket>>> resultHandler) {
    ...
    _vertx.eventBus().<JsonArray>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        ...
        resultHandler.handle(Future.succeededFuture(res.result().body().stream().map(o -> o instanceof Map ? new Ticket(new JsonObject((Map) o)) : new Ticket((JsonObject) o)).collect(Collectors.toList())));
      }
    });
    return this;
  }
  ...
  public TicketService getSpecificTickets(List<Integer> ticketIds, Handler<AsyncResult<List<Ticket>>> resultHandler) {
    ...
    JsonObject _json = new JsonObject();
    _json.put("ticketIds", new JsonArray(ticketIds));
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getSpecificTickets");
    _vertx.eventBus().<JsonArray>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public TicketService deleteTicket(String title, Handler<AsyncResult<Void>> resultHandler) {
    ...
    _json.put("title", title);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "deleteTicket");
    _vertx.eventBus().<Void>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
