  ...
  var TicketService = function(eb, address) {
    ...
    this.getSpecificTickets = function(ticketIds, resultHandler) {
      ...
      if (__args.length === 2 && typeof __args[0] === 'object' && __args[0] instanceof Array && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"ticketIds":__args[0]}, {"action":"getSpecificTickets"}, function(err, result) { __args[1](err, result &&result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.deleteTicket = function(title, resultHandler) {
      ...
      if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"title":__args[0]}, {"action":"deleteTicket"}, function(err, result) { __args[1](err, result &&result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
