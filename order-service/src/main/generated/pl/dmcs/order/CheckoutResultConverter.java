...
/**
 * Converter for {@link CheckoutResult}.
 *
 * NOTE: This class has been automatically generated from the {@link CheckoutResult} original class using Vert.x codegen.
 */
public class CheckoutResultConverter {
  ...
  public static void fromJson(JsonObject json, CheckoutResult obj) {
    ...
    if (json.getValue("order") instanceof JsonObject) {
      obj.setOrder(new Order((JsonObject)json.getValue("order")));
    }
  }
