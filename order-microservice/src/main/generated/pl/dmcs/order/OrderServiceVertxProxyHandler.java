  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "save": {
          service.save(json.getJsonObject("order") == null ? null : new pl.dmcs.order.Order(json.getJsonObject("order")), createHandler(msg));
          break;
        }
        case "deleteOrder": {
          service.deleteOrder(json.getValue("id") == null ? null : (json.getLong("id").intValue()), createHandler(msg));
          break;
        }
        case "checkAvailability": {
          service.checkAvailability(json.getJsonObject("orderDto") == null ? null : new pl.dmcs.order.dto.OrderDto(json.getJsonObject("orderDto")), createHandler(msg));
          break;
        }
        case "getOrder": {
          service.getOrder(json.getValue("id") == null ? null : (json.getLong("id").intValue()), res -> {
            if (res.failed()) {
        ...
        case "createOrder": {
          service.createOrder(json.getJsonObject("orderDto") == null ? null : new pl.dmcs.order.dto.OrderDto(json.getJsonObject("orderDto")), createHandler(msg));
          break;
        }
        default: {
